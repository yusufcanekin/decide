...
public class CMVTest {
    ...
    */
     ...
     * such that one point is at a distance greater than DIST from the line joining the first
     * and last points of the set.
     */
    @Test
    public void testLic6_true_whenPointFartherThanDIST_fromLine() {
        Main.PARAMETERS = new Main.Parameters();
     ...
     * all points are within or on the distance DIST from the line.
     */
    @Test
    public void testLic6_false_whenAllPointsWithinDIST_ofLine() {
        Main.PARAMETERS = new Main.Parameters();
        Main.PARAMETERS.N_PTS = 3;
        Main.PARAMETERS.DIST = 1.0;
    ...
    /**
     * LIC 6 special case: if the first and last points of the N_PTS set coincide,
     * the distance is measured from that coincident point instead of a line.
     */
    @Test
    public void testLic6_true_whenEndpointsCoincide_andOtherPointFar() {
        Main.PARAMETERS = new Main.Parameters();
        Main.PARAMETERS.N_PTS = 3;
        Main.PARAMETERS.DIST = 1.0;
    ...
    /**
     * LIC 6 sliding window: should be true if ANY window of N_PTS consecutive points triggers,
     * even if earlier windows do not.
     */
    @Test
    public void testLic6_true_inLaterWindow_whenFirstWindowFalse() {
        Main.PARAMETERS = new Main.Parameters();
        Main.PARAMETERS.N_PTS = 3;
        Main.PARAMETERS.DIST = 1.0;
    ...
    /**
     * LIC 7 should return true if there exists at least one pair of points separated by exactly
     * K_PTS points in between, such that the distance between the pair is greater than LENGTH1.
     */
    @Test
    public void testLic7_true_whenTwoPointsWithKPtsBetween_areFartherThanLENGTH1() {
        Main.PARAMETERS = new Main.Parameters();
     ...
     */
    @Test
    public void testLic7_false_whenDistanceNotGreaterThanLENGTH1() {
        Main.PARAMETERS = new Main.Parameters();
        Main.PARAMETERS.K_PTS = 1;
    ...
    /**
     * LIC 7 with K_PTS > 1: checks a non-trivial separation.
     */
    @Test
    public void testLic7_true_withKPtsGreaterThan1() {
        Main.PARAMETERS = new Main.Parameters();
    ...
    /**
     * LIC 8 should return true if there exists at least one set of three points separated by
     * A_PTS and B_PTS that cannot be contained in or on a circle of radius RADIUS1.
     */
    @Test
    public void testLic8_true_whenTripleCannotFitInCircleRadius1() {
        Main.PARAMETERS = new Main.Parameters();
    ...
    /**
     * LIC 8 should return false if all such triples can be contained in or on a circle of radius RADIUS1.
     */
    @Test
    public void testLic8_false_whenTripleFitsInCircleRadius1() {
        Main.PARAMETERS = new Main.Parameters();
        Main.PARAMETERS.A_PTS = 1;
        Main.PARAMETERS.B_PTS = 1;
    ...
    /**
     * LIC 8 collinear case: minimum enclosing circle radius becomes maxDistance/2.
     * Here, points (0,0), (4,0), (8,0) require radius 4 to fit.
     */
    @Test
    public void testLic8_collinearPoints_boundaryBehavior() {
        Main.NUMPOINTS = 5;
